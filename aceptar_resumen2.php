...
if ($resumen['status'] == 'presentado'){
    printf("<p><input  type=\"radio\" name=\"status\"  value=\"%s\" id=\"%s\"  checked></p> \n", $resumen['status'],$resumen['status']);
    printf("<p><input  type=\"radio\" name=\"status\"  value=\"aceptado\" id=\"aceptado\"  checked> </p>\n");
    printf("<p><input  type=\"radio\" name=\"status\"  value=\"aceptado\" id=\"rechazado\"  checked></p> \n");
    printf("<p><input  type=\"radio\" name=\"status\"  value=\"aceptado\" id=\"cancelado\"  checked> </p>\n");
}elseif($resumen['status'] == 'aceptado'){
     
    printf("<p><input  type=\"radio\" name=\"status\"  value=\"presentado\" id=\"presentado\"  checked></p> \n");
    printf("<p><input  type=\"radio\" name=\"status\"  value=\"%s\" id=\"%s\"  checked><p> \n", $resumen['status'],$resumen['status']);
    printf("<p><input  type=\"radio\" name=\"status\"  value=\"aceptado\" id=\"rechazado\"  checked></p> \n");
    printf("<p><input  type=\"radio\" name=\"status\"  value=\"aceptado\" id=\"cancelado\"  checked></p> \n");
...
}elseif($resumen['status'] == 'rechazado'){
...
}elseif($resumen['status'] == 'cancelado'){
